...
switch (action.type){
    ...
    case SEARCH_WEATHER:
        return {...state, weather: action.weather, country: action.country, isFetching: false, isWeatherError: false }
...
export const setWeatherFetch = () =>(
    {type:SET_WEATHER_FETCH}
)

export const searchWeather = (payload) =>(
    {type:SEARCH_WEATHER, weather: payload.weather, country: payload.country}
)

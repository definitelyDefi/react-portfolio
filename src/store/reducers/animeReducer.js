...
export const reset_anime = () => ({ type: RESET_ANIME });

export const setGenres = (payload) => ({ type: SET_GENRES, genres: payload });

export const setSearchFetch = () => ({ type: SET_SEARCH_FETCH });

export const setViewFetch = () => ({ type: SET_VIEW_FETCH });

export const setAnimes = (payload) => ({ type: SEARCH_ANIME, items: payload });
